...
def populate():
    ...
    add_page(cat=python_cat,
        ...
        url="http://www.korokithakis.net/tutorials/python/", views=126)

    django_cat = add_cat(name="Django", views=64, likes=32)

    add_page(cat=django_cat,
        title="Official Django Tutorial",
        url="https://docs.djangoproject.com/en/1.5/intro/tutorial01/", views=3)

    add_page(cat=django_cat,
        title="Django Rocks",
        url="http://www.djangorocks.com/", views=58)

    add_page(cat=django_cat,
        title="How to Tango with Django",
        url="http://www.tangowithdjango.com/", views=342)
    ...
    add_page(cat=frame_cat,
        title="Flask",
        url="http://flask.pocoo.org", views=76)
